/**
 * Footer — Figma-accurate Airbnb footer.
 * 4-column link grid + bottom bar with copyright, social icons, selectors.
 */
...
const LANGUAGES  = ['English (US)', 'Español', 'Français', 'Deutsch', 'Português'];
...
const FacebookIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18"
    ...
    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438
      9.878V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0
...
const InstagramIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18"
    ...
    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919
      ...
      0 12 0zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4
      0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0
      0-2.881z" />
  </svg>
);

const socials = [
  { label: 'Facebook',   href: 'https://www.facebook.com/airbnb',       Icon: FacebookIcon },
  { label: 'Twitter / X',href: 'https://twitter.com/airbnb',            Icon: TwitterIcon },
  { label: 'Instagram',  href: 'https://www.instagram.com/airbnb',      Icon: InstagramIcon },
];
      ...
      <div className="site-footer__bottom">
        <div className="container site-footer__bottom-inner">
          ...
          <p className="site-footer__copyright">
            ...
            <span className="site-footer__copyright-dot">·</span>
            <span className="site-footer__copyright-links">
              <a href="https://www.airbnb.com/terms" target="_blank" rel="noopener noreferrer">
                Terms
              </a>
              <span className="site-footer__copyright-dot">·</span>
              <a href="https://www.airbnb.com/terms/privacy_policy" target="_blank" rel="noopener noreferrer">
                Privacy
              </a>
              <span className="site-footer__copyright-dot">·</span>
              <a href="https://www.airbnb.com/sitemaps/v2" target="_blank" rel="noopener noreferrer">
                Sitemap
              </a>
            </span>
          </p>
          ...
          <div className="site-footer__right">
            <div className="site-footer__socials">
              {socials.map(({ label, href, Icon }) => (
                <a key={label} href={href} target="_blank" rel="noopener noreferrer"
                  aria-label={label} className="site-footer__social-link">
                  <Icon />
                </a>
              ))}
            </div>
            ...
            <div className="site-footer__selectors">
              ...
              <button
                type="button"
                onClick={() => setCurrIdx((i) => (i + 1) % CURRENCIES.length)}
